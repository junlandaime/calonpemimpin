        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="md:flex">
                ...
                <div class="p-8">
                    ...
                    <h1 class="mt-1 text-3xl font-bold">{{ $calon->nama }}</h1>
            ...
            <div class="px-8 py-6 border-t border-gray-200">
                ...
                <ul class="space-y-4">
                    @foreach (json_decode($calon->program_unggulan) as $program)
                        <li>
                            <h3 class="font-semibold">{{ $program->nama }}</h3>
            ...
            <div class="px-8 py-6 border-t border-gray-200">
                <h2 class="text-2xl font-bold mb-4">Pendidikan Terakhir</h2>
                @php
                    $pendidikan = json_decode($calon->pendidikan);
                    $pendidikanTerakhir = end($pendidikan);
                @endphp
                <p class="text-gray-700">{{ $pendidikanTerakhir->tingkat }} {{ $pendidikanTerakhir->jurusan }},
                    {{ $pendidikanTerakhir->institusi }} ({{ $pendidikanTerakhir->tahun_lulus }})</p>
            </div>

            <div class="px-8 py-6 border-t border-gray-200 flex justify-between items-center">
